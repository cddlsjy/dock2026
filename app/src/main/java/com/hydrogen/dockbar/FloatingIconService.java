...
public class FloatingIconService extends Service {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (isDragging) {
                            ...
                            View child = findChildAt(v, (int) event.getX(), (int) event.getY());
                            if (child != null) {
                                child.performClick();
                            }
    ...
    private View findChildAt(View parent, int x, int y) {
        ...
        for (int i = group.getChildCount() - 1; i >= 0; i--) {
            ...
            if (x >= childLeft && x < childLeft + child.getWidth() &&
                y >= childTop && y < childTop + child.getHeight()) {
                return child;
            }
        }
        return null;
